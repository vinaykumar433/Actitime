...
public class TestCase_TC017 extends BaseTest
{
	...
	public void test17() 
	{
		...
		String reportType = ExcelDataProvider.getStringValue(XL_PATH, "ReportPage Details", 2, 0);
		...
		Reporter.log("User is bale to create Time Reports of 'Time Balance & Overtime' and it reflects in Reports Dashboard.", true);
	}
