...
public class TestCase_TC022 extends BaseTest
{
	...
	public void test23() 
	{
		...
		String reportType = ExcelDataProvider.getStringValue(XL_PATH, "ReportPage Details", 9, 0);
		...
		Reporter.log("User is bale to create the Cost & Billing Reports of 'Profit / Loss' and it reflects in Reports Dashboard.", true);
	}
