...
public class TestCase_TC018 extends BaseTest
{
	...
	public void test18() 
	{
		...
		String reportType = ExcelDataProvider.getStringValue(XL_PATH, "ReportPage Details", 4, 0);
		...
		Reporter.log("User is bale to create Time Reports of 'Time-Track In Detail' and it reflects in Reports Dashboard.", true);
	}
