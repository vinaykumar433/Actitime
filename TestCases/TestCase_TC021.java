...
public class TestCase_TC021 extends BaseTest
{
	...
	public void test21() 
	{
		...
		String reportType = ExcelDataProvider.getStringValue(XL_PATH, "ReportPage Details", 7, 0);
		...
		Reporter.log("User is bale to create the Cost & Billing Reports of 'Invoice Export' and it reflects in Reports Dashboard.", true);
	}
