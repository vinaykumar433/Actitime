...
public class TestCase_TC020 extends BaseTest
{
	...
	public void test20() 
	{
		...
		String reportType = ExcelDataProvider.getStringValue(XL_PATH, "ReportPage Details", 6, 0);
		...
		Reporter.log("User is bale to create the Cost & Billing Reports of 'Billing Summary' and it reflects in Reports Dashboard.", true);
	}
