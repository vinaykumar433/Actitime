...
public class TestCase_TC016 extends BaseTest
{
	...
	public void test16() 
	{
		...
		String reportType = ExcelDataProvider.getStringValue(XL_PATH, "ReportPage Details", 3, 0);
		...
		Reporter.log("User is bale to create Time Reports of 'Leave Time & Balances' and it reflects in Reports Dashboard.", true);
	}
